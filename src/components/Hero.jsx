      ...
      <section>
        ...
        <div className="container-xl lg:container m-auto">
          <div className="grid grid-cols-1 md:grid-cols-2  rounded-lg items-center ">
            <div>
              <h3 className="font-bold text-6xl sm:text-center  md:text-left  lg:text-left  xl:text-left">Halo saya <span className="text-indigo-600">Diyawan</span></h3>
              <h4 className="text-gray-400 text-2xl sm:text-center md:text-left  lg:text-left  xl:text-left">Front End Developer</h4>
              <p className="mt-3 text-2xl sm:text-center  md:text-left  lg:text-left  xl:text-left">
              Saya adalah seorang mahasiswa yang mengejar gelar Sarjana Teknik Informatika. Saya
              telah terdaftar dalam program studi ini selama 3 tahun. Sepanjang periode ini, saya
              telah mengabdikan diri pada studi saya dalam pengembangan web, terutama fokus
              pada Front End. Selain itu, saya terus mengasah keterampilan dan mengembangkan
              keterampilan lunak saya selama perjalanan akademik saya baik melalui course bahkan
              even seminar.
              Saya juga memiliki kemampuan komunikasi yang sangat baik dan mampu bekerja secara
              efektif dalam tim.
              </p>
            </div>
